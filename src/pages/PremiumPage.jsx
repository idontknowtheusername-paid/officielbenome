...
const PremiumPage = () => {
  ...
  const loadPremiumListings = async (page = 1, newFilters = filters) => {
    try {
      ...
      // Utiliser une limite élevée pour la page premium (pagination côté client)
      const data = await listingService.getPremiumListings(100); // Récupérer beaucoup d'annonces
