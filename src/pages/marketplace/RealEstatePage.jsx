...
const RealEstatePage = () => {
  ...
  const pageContent = (
    ...
    <PullToRefresh onRefresh={handleRefresh} pullingContent=''>
      <div className={`min-h-screen bg-gradient-to-br from-background via-background to-green-900/10 text-foreground ${isAppMode ? 'py-4 pb-24' : 'py-12'}`}>
  ...
  if (isAppMode) {
    return (
      <MobilePageLayout title="Immobilier" showBack>
        {pageContent}
      </MobilePageLayout>
    );
  }
