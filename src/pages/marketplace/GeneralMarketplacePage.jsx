...
const GeneralMarketplacePage = () => {
  ...
  // Ajout de 'refresh' dans la déstructuration
  const { 
    listings, 
    loading, 
    error, 
  ...
  const pageContent = (
    ...
    <PullToRefresh onRefresh={handleRefresh} pullingContent=''>
      <div className={`min-h-screen bg-gradient-to-br from-background via-background to-orange-900/10 text-foreground ${isAppMode ? 'py-4 pb-24' : 'py-12'}`}>
  ...
  if (isAppMode) {
    return (
      <MobilePageLayout title="Marketplace" showBack>
        {pageContent}
      </MobilePageLayout>
    );
  }
