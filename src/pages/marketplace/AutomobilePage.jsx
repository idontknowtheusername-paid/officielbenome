...
const AutomobilePage = () => {
  ...
  const pageContent = (
    ...
    <PullToRefresh onRefresh={handleRefresh} pullingContent=''>
      <div className={`min-h-screen bg-gradient-to-br from-background via-background to-blue-900/10 text-foreground ${isAppMode ? 'py-4 pb-24' : 'py-12'}`}>
  ...
  if (isAppMode) {
    return (
      <MobilePageLayout title="Automobile" showBack>
        {pageContent}
      </MobilePageLayout>
    );
  }
